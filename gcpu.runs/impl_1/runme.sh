...
HD_PWD='/home/granthaack/projects/gcpu/gcpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_dp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cpu_dp.tcl -notrace
